...
import NumberInlineInput from '../Common/InlineInput/NumberInlineInput'
import Slider from '../Common/Slider/Slider'

import { useDispatch, useSelector } from 'react-redux';
import { getICHG, getVOut1, getVOut2, getVTerm, npmEnableBuck1Changed, npmEnableBuck2Changed, npmEnableChargingChanged, npmEnableLoadSw1Changed, npmEnableLoadSw2Changed, npmICHGChanged, npmVOut1Changed, npmVOut2Changed,npmVTermChanged, npmEnableV1SetChanged, npmEnableV2SetChanged, getEnableBuck1, getEnableV1Set, getEnableBuck2, getEnableV2Set, getEnableLoadSw1, getEnableLoadSw2, getEnableCharging} from '../../reducers/settingsReducer';
        ...
        <Card title='Charger'>
            <div className="slider-container">
                <FormLabel className='flex-row'>
                    <div><span>V</span><span className='subscript'>TERM</span></div>
                    <div className='flex-row'><NumberInlineInput
                        value={initVTerm}
                        range={{
                            min: 3.50,
                            max: 4.45,
                ...
                <Slider
                    ...
                    onChange={[index => 
                        dispatch(
                            npmVTermChanged(vTermValues[index])
                        )]}
                    range={{
                        min: 0,
            ...
            <div className="slider-container">
                <FormLabel className='flex-row'>
                    <div><span>I</span><span className='subscript'>CHG</span></div>
                    <div className='flex-row'><NumberInlineInput
                        value={initICHG}
                        range={{
                            min: 32,
            ...
            <Toggle
                ...
                onToggle={value => 
                    dispatch(
                        npmEnableChargingChanged(value)
                    )}
                >    
            </Toggle>
        </Card>
...
const BuckCard: FC<buckProps> = ({
    ...
    return (
        ...
        <div className="slider-container">
            <FormLabel className='flex-row'>
                <div><span>V</span><span className='subscript'>OUT</span></div>
                <div className='flex-row'><NumberInlineInput
                    value={initVOut}
                    range={{
                        min: 1,
        ...
        <div className='flex-row'>
            <div><span>V</span><span className='subscript'>SET</span></div>
            <Toggle
                isToggled={initVSet}
                onToggle={value => {
                    if (value)
        ...
        <div className="pmic-control">
            <div className="pmic-control-inner">
                ...
                <BuckCard 
                    ...
                    onVSetToggle={(value) => dispatch(npmEnableV1SetChanged(value))} 
                    onBuckToggle={(value) => dispatch(npmEnableBuck1Changed(value))}      
                ...
                <BuckCard 
                    ...
                    onVSetToggle={(value) => dispatch(npmEnableV2SetChanged(value))}
                    onBuckToggle={(value) => dispatch(npmEnableBuck2Changed(value))} 
