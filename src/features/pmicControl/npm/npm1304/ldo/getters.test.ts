...
describe('PMIC 1304 - Request update commands', () => {
    ...
    test.each(PMIC_1304_LDOS)('Request update ldoVoltage index: %p', index => {
    ...
    test.each(PMIC_1304_LDOS)('Request update ldoEnabled index: %p', index => {
    ...
    test.each(PMIC_1304_LDOS)('Request update ldoMode index: %p', index => {
    ...
    test.each(PMIC_1304_LDOS)(
        'Request update ldoSoftStartCurrent index: %p',
        index => {
