...
describe('PMIC 1304 - Setters Offline tests', () => {
    ...
    test.each(PMIC_1304_BUCKS)('Set setBuckRetentionVOut  index: %p', index => {
    ...
    test.each(PMIC_1304_BUCKS)('Set setBuckMode index: %p', async index => {
    ...
    test.each(PMIC_1304_BUCKS)('Set setBuckEnabled index: %p', async index => {
